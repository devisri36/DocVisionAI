...
class DocVisionOCREngine:
    ...
    def _generate_mock_ocr_results(self, width: int, height: int, filename: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        if "pan" in filename_lower:
            mock_blocks = [
                ("INCOME TAX DEPARTMENT", [40, 40, 250, 70], 0.99),
                ("GOVT OF INDIA", [40, 80, 180, 100], 0.98),
                ("PERMANENT ACCOUNT CARD", [40, 110, 240, 130], 0.98),
                ("PAN Number:", [40, 150, 120, 170], 0.95),
                ("ABCDE1234F", [130, 150, 250, 170], 0.99),
                ("Name:", [40, 190, 80, 210], 0.93),
                ("JOHN", [90, 190, 130, 210], 0.97),
                ("DOE", [140, 190, 170, 210], 0.97),
                ("DOB:", [40, 230, 80, 250], 0.92),
                ("01/01/1990", [90, 230, 180, 250], 0.96)
            ]
